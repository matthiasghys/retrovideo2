...
public class JdbcReservatieRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    @Test
    public void filmReserverenDieNietInVoorraadIsWerktNiet(){
        assertThatExceptionOfType(ReservatieMisluktException.class).isThrownBy(()-> repository.create(new Reservatie(new Klant("test", "test", "test 1", 2160, "test", 50),
                new Film("test", 12, 12, BigDecimal.valueOf(5), 9, 200), LocalDateTime.now())));
    }
